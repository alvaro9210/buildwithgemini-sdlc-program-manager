...
def get_memory_service():
    ...
    location = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_LOCATION") or os.environ.get("GOOGLE_CLOUD_LOCATION") or MEMORY_BANK_LOCATION
    agent_engine_id = os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID") or MEMORY_BANK_ID
